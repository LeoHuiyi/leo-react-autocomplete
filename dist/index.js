...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_index.Autocomplete, {
	    width: 396,
	    data: getData(10000),
	    value: 'leo100',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Autocomplete2 = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var List = (function (_React$Component) {
	    ...
	    function List(args) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(List).call(this, args));
	    }
	            ...
	            return _react2.default.createElement(
	                "div",
	                {
	                    ...
	                    onClick: function onClick(e) {
	                        _this2.handleClick(e, { label: props.label, value: props.value });
	                    },
	...
	var Autocomplete = (function (_React$Component2) {
	    ...
	    function Autocomplete(args) {
	        ...
	        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(Autocomplete).call(this, args));
	        ...
	        _this3.selectedVal = { label: '', value: '' };
	        return _this3;
	    }
	    ...
	    _createClass(Autocomplete, [{
	        ...
	        value: function componentDidUpdate(nextProps, nextState) {
	            if (this.isUseVirtualMenuDom) {
	                ...
	                var virtualBoxTop = this.state.virtualBoxTop;

	                if (virtualBoxTop >= 0 && menu) {
	                    var menuDOM = _reactDom2.default.findDOMNode(this.refs.menu);
	                    var scrollTop = menuDOM.scrollTop;
	        ...
	        value: function setData(data) {
	            var onGetData = this.props.onGetData;
	        ...
	        key: "checkFocusedOption",
	        value: function checkFocusedOption(data) {
	            var focusedOption = this.state.focusedOption;
	            var item = undefined;
	            var inData = false;
	        ...
	        value: function focusAdjacentOption(dir) {
	            ...
	            var ops = this.state.data.filter(function (op) {
	                return !op.disabled;
	            });
	            var stateFocusedOption = this.state.focusedOption;
	        ...
	        key: "getListScrollTop",
	        value: function getListScrollTop(focusedOption) {
	            var top = this.state.virtualBoxTop;
	            var index = this.state.data.indexOf(focusedOption || this.state.focusedOption);
	            var listHeight = this.listHeight;
	            var listTop = index * listHeight;
	            var listBottom = listTop + listHeight;
	            var bottom = top + this.menuHeight;
	        ...
	        value: function handleBlur(event) {
	            ...
	            this._blurTimer = setTimeout(function () {
	                ...
	                var menu = _this6.refs.menu;
	                var btn = _this6.refs.btn;
	                var input = _this6.refs.input;
	                var menuDom = undefined;

	                _this6._blurTimer = null;

	                if (btn && activeEl.isEqualNode(_reactDom2.default.findDOMNode(btn))) {
	                    input && _reactDom2.default.findDOMNode(input).focus();
	                } else if (menu && activeEl.isEqualNode(menuDom = _reactDom2.default.findDOMNode(menu))) {
	                    input && _reactDom2.default.findDOMNode(input).focus();
	                    ...
	                    _this6.setState({
	                        visible: false,
	                        value: _this6.selectedVal.value
	                    }, function () {
	                        _this6.props.onBlur();
	                    });
	                }
	        ...
	        value: function handleClick(event) {
	            if (!this.state.disabled) {
	                this.setState({
	                    value: _reactDom2.default.findDOMNode(this.refs.input).value,
	                    visible: true
	                });
	            }
	        }
	        ...
	        value: function btnClick(event) {
	            ...
	            if (!this.state.disabled) {
	                if (this.state.visible) {
	                    ...
	                    (function () {
	                        var inptu = _reactDom2.default.findDOMNode(_this7.refs.input);
	        ...
	        value: function clearValue(event) {
	            ...
	            if (!this.state.disabled) {
	                this.setState({
	                    ...
	                    _reactDom2.default.findDOMNode(_this8.refs.input).focus();
	                });
	        ...
	        key: "reandClearOrLoading",
	        value: function reandClearOrLoading() {
	            var _this9 = this;
	            ...
	            if (this.state.loading) {
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement("span", { className: "comboBox-loading-inner" })
	                );
	            } else if (this.selectedVal.value) {
	                return _react2.default.createElement(
	                    "span",
	                    { className: "comboBox-clear", onClick: function onClick(e) {
	                            _this9.clearValue(e);
	                        }, ref: "clear", tabIndex: "-1" },
	                    _react2.default.createElement("span", { className: "comboBox-clear-inner", dangerouslySetInnerHTML: { __html: '&times;' } })
	                );
	            } else {
	                return null;
	            }
	        ...
	        value: function renderComboBox() {
	            ...
	            var style = Object.assign(props.style, { width: props.width });
	            var clearOrLoading = this.reandClearOrLoading();
	            var inMarrgin = clearOrLoading ? { margin: '0 32px 0 4px' } : { margin: '0 16px 0 4px' };

	            return _react2.default.createElement(
	                "div",
	                { className: "comboBox", style: style },
	                _react2.default.createElement(
	                    "div",
	                    { className: "comboBox-inputWrap", style: { 'outline': 'none' } },
	                    _react2.default.createElement(
	                        "div",
	                        { style: inMarrgin },
	                        _react2.default.createElement("input", {
	                            ...
	                            onClick: function onClick(e) {
	                                _this10.handleClick(e);
	                            },
	                            onBlur: function onBlur(e) {
	                                _this10.handleBlur(e);
	                            },
	                            onFocus: function onFocus(e) {
	                                _this10.handleFocus(e);
	                            },
	                            onKeyDown: function onKeyDown(e) {
	                                _this10.handleInput(e);
	                            }
	                        })
	                    )
	                ),
	                ...
	                _react2.default.createElement(
	                    "span",
	                    { className: "comboBox-btn", tabIndex: "-1", onClick: function onClick(e) {
	                            _this10.btnClick(e);
	                        }, ref: "btn" },
	                    _react2.default.createElement("span", { className: "comboBox-btn-arrow" })
	                )
	            );
	        }
	    }, {
	        key: "virtualMenuDom",
	        value: function virtualMenuDom() {
	            var _this11 = this;
	            ...
	            var listHeight = this.listHeight = props.listHeight + 1;
	            var menuHeight = this.menuHeight = parseInt(props.menuStyle.maxHeight || props.menuStyle.height);
	            var menuInnerHeight = dataLen * listHeight;

	            if (menuInnerHeight > menuHeight) {
	                var _ret2 = (function () {
	                    var virtualBoxTop = state.virtualBoxTop || 0;
	                    var start = Math.floor(virtualBoxTop / listHeight);
	                    var boxLen = Math.ceil(menuHeight / listHeight);
	                    var end = start + boxLen;
	                    var moreEnd = undefined;
	                    ...
	                    var virtualData = _this11.virtualData = data.slice(start, end);
	                    var labelName = props.labelName;
	                    var valueName = props.valueName;
	                    var selected = props.selected;
	                    var listSelect = false;
	                    var focusedOption = state.focusedOption;
	                    var focusedValue = focusedOption ? focusedOption[valueName] : null;

	                    focusedValue = focusedValue == null ? data[0] : focusedValue;

	                    var lists = virtualData.map(function (item, index) {
	                        var isFocused = focusedValue === item[valueName];
	                        ...
	                        return _react2.default.createElement(List, {
	                            ...
	                            onSelect: function onSelect(obj) {
	                                _this11.onSelect(obj);
	                            },
	                            selected: listSelect,
	                            focused: isFocused,
	                            disabled: item.disabled,
	                            ref: isFocused ? 'focused' : null,
	                            mouseEnter: function mouseEnter(op) {
	                                _this11.focusOption(op);
	                            },
	                            mouseLeave: function mouseLeave(op) {
	                                _this11.unfocusOption(op);
	                            },
	                            opClass: opClass, op: item
	                        });
	                    });

	                    var style = Object.assign({}, _this11.props.menuStyle, { width: _this11.props.width, display: 'block' });

	                    return {
	                        v: _react2.default.createElement(
	                            "div",
	                            { className: "listMenu", style: style, tabIndex: "-1", ref: "menu", onScroll: function onScroll(e) {
	                                    _this11.handleScroll(e);
	                                } },
	                            _react2.default.createElement(
	                                "div",
	                                { style: { height: menuInnerHeight, position: 'relative' } },
	                                _react2.default.createElement(
	                                    "div",
	                                    { style: { top: virtualBoxTop, position: 'absolute', left: 0, width: '100%' } },
	                                    lists
	                                )
	                            )
	                        )
	        ...
	        value: function menuDom() {
	            ...
	            if (state.visible && data.length) {
	                var _ret3 = (function () {
	                    ...
	                    lists = data.map(function (item, index) {
	                        var isFocused = focusedValue === item[valueName];
	                        listSelect = selected === item[valueName] ? true : false;
	                        var opClass = cx({
	                            'listMenu-item': true,
	                    ...
	                    _this12._focusedOptionReveal = true;

	                    var style = Object.assign({}, _this12.props.menuStyle, { width: _this12.props.width, display: 'block' });

	                    return {
	                        v: _react2.default.createElement(
	                            "div",
	                            { className: "listMenu", style: style, tabIndex: "-1", ref: "menu" },
	                            _react2.default.createElement(
	                                "div",
	                                null,
	                                lists
	        ...
	        key: "render",
	        value: function render() {
	            var autoCx = this.state.disabled ? "autocomplete is-disabled" : "autocomplete";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/autoprefixer-loader/index.js!./autocomplete.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/autoprefixer-loader/index.js!./autocomplete.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var def = __webpack_require__(168).setDesc
	  , has = __webpack_require__(183)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setDesc    = __webpack_require__(168).setDesc
	  ...
	  , NAME       = 'name';
	// 19.2.4.2 name
	NAME in FProto || __webpack_require__(174) && setDesc(FProto, NAME, {
	  configurable: true,
	  get: function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $           = __webpack_require__(168)
	  ...
	  , fails       = __webpack_require__(175)
	  , $trim       = __webpack_require__(229).trim
	  , NUMBER      = 'Number'
	...
	if(!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')){
	  ...
	  $.each.call(__webpack_require__(174) ? $.getNames(Base) : (
	    // ES3:
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S, 'Math', {expm1: __webpack_require__(249)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(229)('trim', function($trim){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(172)(IteratorPrototype, __webpack_require__(197)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 21.2.5.3 get RegExp.prototype.flags()
	var $ = __webpack_require__(168);
	if(__webpack_require__(174) && /./g.flags != 'g')$.setDesc(RegExp.prototype, 'flags', {
	  configurable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@match logic
	__webpack_require__(298)('match', 1, function(defined, MATCH){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@search logic
	__webpack_require__(298)('search', 1, function(defined, SEARCH){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(168)
	  ...
	  , anObject   = __webpack_require__(186)
	  , aFunction  = __webpack_require__(179)
	  , strictNew  = __webpack_require__(303)
	...
	var USE_NATIVE = function(){
	  ...
	  try {
	    ...
	    if(works && __webpack_require__(174)){
	...
	if(!USE_NATIVE){
	  ...
	  __webpack_require__(308)(P.prototype, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global    = __webpack_require__(170)
	  , macrotask = __webpack_require__(307).set
	  , Observer  = global.MutationObserver || global.WebKitMutationObserver
	  , process   = global.process
	  , Promise   = global.Promise
	  , isNode    = __webpack_require__(184)(process) == 'process'
	  , head, last, notify;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!setTask || !clearTask){
	  ...
	  // Node.js 0.8-
	  if(__webpack_require__(184)(process) == 'process'){
	    defer = function(id){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $WeakMap = __webpack_require__(311)('WeakMap', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $         = __webpack_require__(168)
	  ...
	  , anObject  = __webpack_require__(186)
	  , isObject  = __webpack_require__(182)
	  , bind      = Function.bind || __webpack_require__(171).Function.prototype.bind;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(284)('includes');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(169)
	  , $at     = __webpack_require__(264)(true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(168)
	  , $export    = __webpack_require__(169)
	  , ownKeys    = __webpack_require__(327)
	  , toIObject  = __webpack_require__(189)
	  , createDesc = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P, 'Map', {toJSON: __webpack_require__(345)('Map')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P, 'Set', {toJSON: __webpack_require__(345)('Set')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $       = __webpack_require__(168)
	  , $export = __webpack_require__(169)
	  , $ctx    = __webpack_require__(178)
	  , $Array  = __webpack_require__(171).Array || Array
	  , statics = {};
